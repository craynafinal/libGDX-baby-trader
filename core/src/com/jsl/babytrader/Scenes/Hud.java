package com.jsl.babytrader.Scenes;
...
public class Hud implements Disposable {
    ...
    public Hud (SpriteBatch sb) {
        ...
        babyTraderLabel = new Label(String.format("Baby Trader"), new Label.LabelStyle(new BitmapFont(), Color.WHITE));

        table.add(babyTraderLabel).expandX().padTop(10); // each label takes portion of row
