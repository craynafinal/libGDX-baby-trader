...
public class InitScreen extends BaseScreen {
    ...
    private void labelSetup() {
        String copyright = "Copyright (c) " + Calendar.getInstance().get(Calendar.YEAR) + " Jong Seong Lee".toUpperCase();

        label_copyright = new Label(copyright, getLabelStyle(FONT_WORK_EXTRA_BOLD, 13, FONT_COLOR_DARK_BLUE));
        label_copyright.setPosition(MARGIN_LEFT + 62, 24);
    }
    ...
    public void render(float delta) {
        ...
        game.batch.begin();
        game.batch.draw(sprite_babyTrader, SCREEN_WIDTH - sprite_babyTrader.getWidth(), 0);
        game.batch.draw(sprite_title, MARGIN_LEFT, SCREEN_HEIGHT - sprite_title.getHeight() - 30);
